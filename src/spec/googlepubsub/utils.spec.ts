...
} from '../../googlepubsub/utils';
import {eventBuilder, eventBuilderWithDefaults, eventstoreResponse, wrongEntries} from './utils';
import {createServer} from 'http';

describe('GoogleBus Utils',  () => {
	describe('GoogleBus isValidDecodedEventStore', () => {
		it('_should return true if it is a valid event store event', () => {
	...
	describe('GoogleBus decodeEventstoreEntry', () => {
		it('_should decode correctly the entries from Eventstore', () => {
	...
	describe('GoogleBus decodeEventstoreResponse', () => {
		it('_should decode correctly the entries from Eventstore', () => {
	...
	describe('GoogleBus eventstoreFeedbackHTTP', () => {
